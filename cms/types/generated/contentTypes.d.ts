...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['news', 'tech_guide', 'comparison', 'case_study']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_rosca: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'default.seo-component', false>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bitrix_lead_id: Schema.Attribute.Integer;
    ...
    status: Schema.Attribute.Enumeration<
      ['new', 'processing', 'sent', 'closed', 'cancelled']
    >;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    analogues: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    article: Schema.Attribute.String;
    brand: Schema.Attribute.Enumeration<
      ['hiwin', 'rosca', 'delta', 'estun', 'item', 'other']
    >;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    pdf_catalog: Schema.Attribute.Media<'files'>;
    price: Schema.Attribute.Decimal;
    price_opt: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'default.seo-component', false>;
